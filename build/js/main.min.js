					...
					return h(
						...
						h(
							...
							h(
								...
								this.props.superMode && "Ultra-Super",
								" Cuteness"
							)
						)
					);
	...
	var App = (function(_Component) {
		...
		function App(props) {
			...
			_this.getNewCute = function() {
				getCuteGifs(_this.state.superMode).then(function(images) {
					var rnmd = Math.floor(Math.random() * images.length);
					console.log("images are", images, images[rnmd]);
					_this.setState({ selection: images[rnmd].images.original.url });
				});
			};
					...
					document.addEventListener("keydown", function(event) {
						...
						if (buffer.join("") === "maria") {
							_this2.setState({
								superMode: true,
								background:
									"https://media.giphy.com/media/qKCFeFGiojrAQ/giphy.gif"
							});
						}
