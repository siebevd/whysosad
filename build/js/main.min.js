!(function() {
					...
					(s = "function" != typeof e) &&
						(null == a
							...
							: "number" == typeof a
								? (a = String(a))
								: "string" != typeof a && (s = !1)),
					s && i ? (c[c.length - 1] += a) : c === o ? (c = [a]) : c.push(a),
					(i = s);
		var p = new function() {}();
		return (
			(p.nodeName = e),
			(p.children = c),
			(p.attributes = null == r ? void 0 : r),
			(p.key = null == r ? void 0 : r.key),
	...
	function c(e) {
		!e._dirty &&
			(e._dirty = !0) &&
			1 == l.push(e) &&
			(t.debounceRendering || a)(p);
	}
	function p() {
		var e,
			t = l;
		for (l = []; (e = t.pop()); ) e._dirty && A(e);
	}
	function u(e, t) {
		return (
	...
	function C(e, t, n, o, r) {
			...
			return (
				e && void 0 !== e.splitText && e.parentNode && (!e._component || r)
					...
					: ((i = document.createTextNode(t)),
						e && (e.parentNode && e.parentNode.replaceChild(i, e), x(e, !0))),
				(i.__preactattr_ = !0),
				i
			);
		var s,
		...
		if (null == _) {
			_ = i.__preactattr_ = {};
			for (var m = i.attributes, g = m.length; g--; ) _[m[g].name] = m[g].value;
		}
		return (
			!y &&
			v &&
			...
			void 0 !== p.splitText &&
			null == p.nextSibling
				? p.nodeValue != v[0] && (p.nodeValue = v[0])
				: ((v && v.length) || null != p) &&
					(function(e, t, n, o, r) {
						var i,
							a,
						...
						if (0 !== m)
							for (var g = 0; g < m; g++) {
								var k = p[g],
									w = k.__preactattr_,
									N =
										y && w ? (k._component ? k._component.__key : w.key) : null;
								null != N
									? (_++, (h[N] = k))
									: (w ||
											(void 0 !== k.splitText
						...
						if (0 !== y)
							for (var g = 0; g < y; g++) {
								...
								var N = l.key;
								if (null != N)
									_ && void 0 !== h[N] && ((c = h[N]), (h[N] = void 0), _--);
								else if (!c && v < b)
									for (i = v; i < b; i++)
										if (
											void 0 !== d[i] &&
											...
											"string" == typeof (S = l) || "number" == typeof S
												...
												: "string" == typeof S.nodeName
													? !T._componentConstructor && u(T, S.nodeName)
													: M || T._componentConstructor === S.nodeName)
										) {
											(c = a),
												(d[i] = void 0),
												i === b - 1 && b--,
								...
								(c = C(c, l, n, o)),
									...
									c &&
										...
										(null == s
											? e.appendChild(c)
											: c === s.nextSibling ? f(s) : e.insertBefore(c, s));
							}
						var T, S, M;
						if (_) for (var g in h) void 0 !== h[g] && x(h[g], !1);
						for (; v <= b; ) void 0 !== (c = d[b--]) && x(c, !1);
					})(i, v, n, o, y || null != _.dangerouslySetInnerHTML),
			(function(e, t, n) {
				var o;
				for (o in n)
					(t && null != t[o]) ||
						null == n[o] ||
						h(e, o, n[o], (n[o] = void 0), b);
				for (o in t)
					"children" === o ||
						"innerHTML" === o ||
						(o in n &&
	...
	function T(e, t, n) {
		...
		if (
			(e.prototype && e.prototype.render
				...
				: (((o = new j(t, n)).constructor = e), (o.render = S)),
			r)
		)
		...
		if (!e._disable) {
			...
			if (
				(b &&
					...
					!1 === e.shouldComponentUpdate(c, p, u)
						? (N = !0)
						: e.componentWillUpdate && e.componentWillUpdate(c, p, u),
					(e.props = c),
					(e.state = p),
					(e.context = u)),
				...
				if ("function" == typeof L) {
					var P = d(a);
					(s = w) && s.constructor === L && P.key == s.__key
						? M(s, P, 1, u, !1)
						: ((S = s),
							(e._component = s = T(L, P, u)),
					...
					(l = C),
						(S = w) && (l = e._component = null),
						(C || 1 === n) &&
							(l && (l._component = null),
							(j = k(l, a, u, o || !b, C && C.parentNode, !0)));
				if (C && j !== C && s !== w) {
					var U = C.parentNode;
					U &&
						j !== U &&
						(U.replaceChild(j, C), S || ((C._component = null), x(C, !1)));
				}
				if ((S && D(S), (e.base = j), j && !r)) {
					for (var B = e, E = e; (E = E._parentComponent); ) (B = E).base = j;
			...
			if (
				(!b || o
					? v.unshift(e)
					: N ||
						(e.componentDidUpdate && e.componentDidUpdate(f, h, _),
	...
	function D(e) {
		...
		i
			? D(i)
			: n &&
				(n.__preactattr_ && n.__preactattr_.ref && n.__preactattr_.ref(null),
				(e.nextBase = n),
				f(n),
				(r = (o = e).constructor.name),
				(N[r] || (N[r] = [])).push(o),
				w(n)),
	...
	var L = { giphy: { apiKey: "dfFJypbhn5phpjI9YiDceoNTCFu0qzDV" } };
	function P(e, t) {
		var n = "";
		return (
			t && (n = "&offset=" + Math.round(2e3 * Math.random())),
			fetch(
	...
	var U = "Decision_container__3s8R5",
		B = "Decision_subTitle__1A7o2",
		E = "Decision_buttonContainer__2QVL7",
		O = "Decision_button__2GF3M";
	e(
	...
	var q = function(e, t) {
		...
		R = (function(e) {
			function t(e) {
				return (
					q(this, t),
					W(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e))
				);
			}
			return (
				V(t, j),
				z(t, [
					{
						...
						value: function() {
							return r(
								"div",
								{ className: U },
								r("img", { src: "/assets/whysosad.png" }),
								r("img", { src: "/assets/question.png" }),
								r("h2", { className: B }, "Give me some"),
								r(
									"div",
									{ className: E },
									r(
										"button",
										{ className: O, onClick: this.props.getNewCute },
										"Cuteness"
									),
									r("button", { className: O }, "Lolz")
								)
							);
						}
					}
					...
					for (var e = [], o = 0; o < arguments.length; o++) {
						...
						if (r) {
							...
							if ("string" === i || "number" === i)
								...
								for (var a in r)
									t.call(r, a) && r[a] && e.push((this && this[a]) || a);
						}
					}
					return e.join(" ");
				}
	...
	var G = I.bind(F),
		K = (function(e) {
			function t(e) {
				...
				return (
					(n.getNewCute = function() {
						P("cute puppy", !0).then(function(e) {
							n.setState({ selection: e[0].images.original.url });
						});
					}),
					(n.keyDownHandler = function(e) {
						32 === e.which && n.state.selection && n.getNewCute();
					}),
					(n.state = { type: "" }),
					n
				);
				...
				z(t, [
					{
						...
						value: function() {
							var e = this;
							P("sad", !0).then(function(t) {
								e.setState({ background: t[0].images.original.url });
							}),
						...
						value: function() {
							...
							return r(
								...
								this.state.type.length < 1 &&
									...
									r(R, { getNewCute: this.getNewCute }),
								r(
									"div",
									{ className: e },
